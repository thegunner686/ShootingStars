...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ViewController = __webpack_require__(159);
	...
	_reactDom2.default.render(_react2.default.createElement(_ViewController2.default, null), app);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ViewController = function (_React$Component) {
	    ...
	    function ViewController() {
	        ...
	        var _this = _possibleConstructorReturn(this, (ViewController.__proto__ || Object.getPrototypeOf(ViewController)).call(this));

	        _this.state = {
	            currentView: _react2.default.createElement(_Level2.default, null)
	        };
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BasicLevel = __webpack_require__(162);

	var _BasicLevel2 = _interopRequireDefault(_BasicLevel);

	var _Level1Mechanics = __webpack_require__(163);

	var _Level1Mechanics2 = _interopRequireDefault(_Level1Mechanics);
	...
	var l1m = new _Level1Mechanics2.default();
	...
	var Level1 = function (_React$Component) {
	    ...
	    _createClass(Level1, [{
	        ...
	        value: function start() {
	            var canvas = document.getElementById("level1"),
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                null,
	                _react2.default.createElement("canvas", { id: "level1" })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BasicLevel = function (_React$Component) {
	    _inherits(BasicLevel, _React$Component);

	    function BasicLevel() {
	        _classCallCheck(this, BasicLevel);

	        return _possibleConstructorReturn(this, (BasicLevel.__proto__ || Object.getPrototypeOf(BasicLevel)).call(this));
	    }

	    _createClass(BasicLevel, [{
	        key: "render",
	        value: function render() {
	            return null;
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Barrier = __webpack_require__(167);

	var _Barrier2 = _interopRequireDefault(_Barrier);

	var _BarrierLine = __webpack_require__(168);

	var _BarrierLine2 = _interopRequireDefault(_BarrierLine);

	var _Flare = __webpack_require__(169);

	var _Flare2 = _interopRequireDefault(_Flare);

	var _Player3 = __webpack_require__(170);

	var _Player4 = _interopRequireDefault(_Player3);

	var _Player5 = __webpack_require__(171);

	var _Player6 = _interopRequireDefault(_Player5);

	var _Meteors = __webpack_require__(172);

	var _Meteors2 = _interopRequireDefault(_Meteors);

	var _EndgameAnimation = __webpack_require__(173);

	var _EndgameAnimation2 = _interopRequireDefault(_EndgameAnimation);

	var _Player2Endgame = __webpack_require__(174);

	var _Player2Endgame2 = _interopRequireDefault(_Player2Endgame);

	var _Player1Endgame = __webpack_require__(175);

	var _Player1Endgame2 = _interopRequireDefault(_Player1Endgame);

	var _Firework = __webpack_require__(176);
	...
	var Level1Mechanics = function () {
	    function Level1Mechanics() {
	        _classCallCheck(this, Level1Mechanics);
	    ...
	    _createClass(Level1Mechanics, [{
	        key: "init",
	        value: function init(width, height) {
	            var _this = this;

	            this.player1 = new _Player6.default(100, height / 2);
	            this.player2 = new _Player4.default(width - 100, height / 2);
	            this.flare = new _Flare2.default(width / 2, height / 2, 80);
	            this.width = width;
	            this.height = height;
	            var mag = 8;
	            var padding = 50;
	            this.barrierLines.push(new _BarrierLine2.default(-padding, height - padding, Math.floor(width / mag), mag, "horizontal"));
	            this.barrierLines.push(new _BarrierLine2.default(padding, -padding, Math.floor(height / mag), mag, "vertical"));
	            this.barrierLines.push(new _BarrierLine2.default(width - padding, -padding, Math.floor(height / mag), mag, "vertical"));
	            this.barrierLines.push(new _BarrierLine2.default(-padding, padding, Math.floor(width / mag), mag, "horizontal"));

	            for (var i = 0; i < 15; i++) {
	                var mx = padding + Math.random() * (width - padding * 2),
	                ...
	                this.meteors.push(new _Meteors2.default(mx, my, size));
	            }

	            setInterval(function () {
	                for (var _i = 0; _i < Math.floor(Math.random() * 2) + 1; _i++) {
	                    var _mx = padding + Math.random() * (width - padding * 2),
	                        _my = padding + Math.random() * (height - padding * 2),
	                        _size = 5;
	                    while (_this.flare.collided(_mx, _my, _size + 20)) {
	                        _mx = padding + Math.random() * (width - padding * 2);
	                        _my = padding + Math.random() * (height - padding * 2);
	                    }
	                    _this.meteors.push(new _Meteors2.default(_mx, _my, _size));
	                }
	        ...
	        value: function update() {
	            ...
	            var beforeX1 = this.player1.x,
	                beforeY1 = this.player1.y;
	            this.player1.update();

	            var beforeX2 = this.player2.x,
	                beforeY2 = this.player2.y;
	            this.player2.update();

	            var passiveMass = 0;

	            this.barrierLines.map(function (line) {
	                for (var i = 0; i < line.barriers.length; i++) {
	                    var dist1 = distance(line.barriers[i].x, line.barriers[i].y, _this2.player1.x, _this2.player1.y),
	                        dist2 = distance(line.barriers[i].x, line.barriers[i].y, _this2.player2.x, _this2.player2.y);
	                    //console.log(dist1);
	                    if (dist1 < dist2) {
	                        line.barriers[i].setColor(_this2.player1.getColorWithOpacity(1 - dist1 / _this2.height * 2));
	                        passiveMass++; // player 1 is positive
	                    } else {
	                        line.barriers[i].setColor(_this2.player2.getColorWithOpacity(1 - dist2 / _this2.height * 2));
	                        passiveMass--; // player 2 is negative
	                    }
	                    var bounceback = 0.6,
	                        immediate = 0;

	                    if (line.barriers[i].collided(_this2.player1.x, _this2.player1.y, _this2.player1.width)) {
	                        var velocY = _this2.player1.vy,
	                            velocX = _this2.player1.vx;
	                        //this.fireworks.push(new Firework(line.barriers[i].x, line.barriers[i].y));
	                        if (line.direction == "horizontal") {
	                            _this2.player1.y = beforeY1;
	                            _this2.player1.vy *= -bounceback;
	                            line.barriers[i].vy = velocY * 0.02;
	                            if (line.barriers[i].x > _this2.player1.x) {
	                                _this2.player1.x -= immediate;
	                            } else {
	                                _this2.player1.x += immediate;
	                            }
	                        } else {
	                            _this2.player1.x = beforeX1;
	                            _this2.player1.vx *= -bounceback;
	                            line.barriers[i].vx = velocX * 0.02;
	                            if (line.barriers[i].y > _this2.player1.y) {
	                                _this2.player1.y -= immediate;
	                            } else {
	                                _this2.player1.y += immediate;
	                            }
	                        }
	                    ...
	                    if (line.barriers[i].collided(_this2.player2.x, _this2.player2.y, _this2.player2.width)) {
	                        var _velocY = _this2.player2.vy,
	                            _velocX = _this2.player2.vx;
	                        //this.fireworks.push(new Firework(line.barriers[i].x, line.barriers[i].y));
	                        if (line.direction == "horizontal") {
	                            _this2.player2.y = beforeY2;
	                            _this2.player2.vy *= -bounceback;
	                            line.barriers[i].vy = _velocY * 0.1;
	                            if (line.barriers[i].x > _this2.player2.x) {
	                                _this2.player2.x -= immediate;
	                            } else {
	                                _this2.player2.x += immediate;
	                            }
	                        } else {
	                            _this2.player2.x = beforeX2;
	                            _this2.player2.vx *= -bounceback;
	                            line.barriers[i].vx = _velocX * 0.02;
	                            if (line.barriers[i].y > _this2.player2.y) {
	                                _this2.player2.y -= immediate;
	                            } else {
	                                _this2.player2.y += immediate;
	                            }
	                        }
	                ...
	                if (passiveMass > 0) {
	                    _this2.player1.mass += 0.1;
	                } else if (passiveMass < 0) {
	                    _this2.player2.mass += 0.1;
	                }
	            });
	        }
	    }, {
	        ...
	        value: function draw(ctx) {
	            ...
	            this.barrierLines.map(function (b) {
	                b.draw(ctx);
	            });
	            this.flare.draw(ctx);
	            if (this.flare.collided(this.player1.x, this.player1.y, this.player1.radius)) {
	                this.playing = false;
	                this.winner = new _Player2Endgame2.default(this.width / 2, this.height / 2, 80);
	                this.endGame();
	            } else if (this.flare.collided(this.player2.x, this.player2.y, this.player2.radius)) {
	                this.playing = false;
	                this.winner = new _Player1Endgame2.default(this.width / 2, this.height / 2, 80);
	                this.endGame();
	            }
	            ...
	            // fireworks
	            for (var _i2 = this.fireworks.length - 1; _i2 > 0; _i2--) {
	                this.fireworks[_i2].draw(ctx);
	                if (this.fireworks[_i2].particles.length == 0) {
	                    this.fireworks.splice(_i2, 1);
	                }
	            }
	        }
	    }, {
	        ...
	        value: function endGame() {
	            this.animationElement = new _EndgameAnimation2.default(this.width / 2, this.height / 2, 80);
	        }
	    }]);

	    return Level1Mechanics;
	}();

	exports.default = Level1Mechanics;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vm = __webpack_require__(165);
	...
	var Player = function () {
	    function Player(x, y) {
	        ...
	        document.body.addEventListener("keydown", function (e) {
	            return _this.keyHandlerDown(e);
	        });
	        document.body.addEventListener("keyup", function (e) {
	            return _this.keyHandlerUp(e);
	        });
	    }

	    _createClass(Player, [{
	        key: "keyHandlerUp",
	        value: function keyHandlerUp(e) {
	            var mag = 5;
	            switch (e.keyCode) {
	                case 87:
	        ...
	        key: "keyHandlerDown",
	        value: function keyHandlerDown(e) {
	            var mag = 5;
	            switch (e.keyCode) {
	                case 87:
	        ...
	        value: function draw(ctx) {
	            ...
	            ctx.fillStyle = "rgba(40, 230, " + (50 + Math.floor(Math.random() * 200)) + ", 0.4)";
	            for (var k = 0; k < Math.floor(Math.random() * 3 + 1); k++) {

	                ctx.lineTo(this.x + (Math.random() < 0.5 ? -this.width / 2 : this.width / 2) + Math.random() * 40 - 20, this.y + (Math.random() < 0.5 ? -this.height / 2 : this.height / 2) + Math.random() * 40 - 20);
	                ctx.stroke();
	                ctx.fill();
	            }
	            ctx.closePath();
	            ...
	            */
	            ...
	            var turnAngle = Math.PI - (this.numSides - 2) * Math.PI / this.numSides;

	            ctx.beginPath();
	            ctx.fillStyle = "white";
	            var lastX = this.x + this.width,
	                lastY = this.y;
...
/***/ function(module, exports) {
	...
	var Barrier = {
		...
		create: function create(x, y, speed, direction, grav, radius) {
		...
		addSpring: function addSpring(point, k, length) {
			this.springs.push({
				point: point,
				k: k,
				length: length || 0
		...
		removeSpring: function removeSpring(point) {
		...
		handleSprings: function handleSprings() {
		...
		springTo: function springTo(point, k, length) {
		...
		collided: function collided(x, y, radius) {
		...
		setActiveDark: function setActiveDark() {
			var _this = this;

			this.activeDark = true;
			setTimeout(function () {
				_this.activeDark = false;
				_this.nextBarrier.setActiveDark();
			}, 20);
		},


		setColor: function setColor(clr) {
			this.clr = clr;
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BarrierLine = function () {
	    function BarrierLine(startX, startY, numBarriers, barrierSize, direction) {
	        _classCallCheck(this, BarrierLine);
	        ...
	        for (var i = 0; i < numBarriers; i++) {
	            ...
	            switch (direction) {
	                case "horizontal":
	                    p = _Barrier2.default.create(startX + 2 * barrierSize * i, startY, 0, 0, 0, barrierSize);
	                    break;
	                case "vertical":
	                    p = _Barrier2.default.create(startX, startY + 2 * barrierSize * i, 0, 0, 0, barrierSize);
	                    break;
	                case "diagonal_decreasing":
	                    p = _Barrier2.default.create(startX + 2 * barrierSize * i, startY - 2 * barrierSize * i, 0, 0, 0, barrierSize);
	                    break;
	        ...
	        var strain = 0.0005;
	        for (var _i = 0; _i < numBarriers; _i++) {
	            var _p = this.barriers[_i];
	            if (_i > 0) {
	                _p.addSpring(this.barriers[_i - 1], strain, 4);
	            }
	            if (_i < numBarriers - 1) {
	                _p.addSpring(this.barriers[_i + 1], strain, 4);
	                _p.nextBarrier = this.barriers[_i + 1];
	            }
	            //console.log(p.x, p.y);
	            _p.addSpring({
	                x: _p.x,
	    ...
	    _createClass(BarrierLine, [{
	        key: "draw",
	        value: function draw(ctx) {
	            this.barriers.map(function (b) {
	                b.update();
	                b.draw(ctx);
	            });
	            ...
	            for (var i = 0; i < this.barriers.length; i++) {
	                ...
	                for (var k = 1; k < this.barriers.length; k++) {
...
/***/ function(module, exports) {
	...
	var Flare = function () {
	    ...
	    _createClass(Flare, [{
	        key: "collided",
	        value: function collided(x, y, radius) {
	        ...
	        value: function draw(ctx) {
	            for (var i = 0; i < Math.floor(Math.random() * 5) + 1; i++) {
	                ctx.fillStyle = "rgba(" + Math.floor(Math.random() * 100 + 155) + ", " + (Math.floor(Math.random() * 50) + 50) + ", 60, 0.8)";
	                ctx.beginPath();
	                ctx.moveTo(this.x, this.y);
	                for (var k = 0; k < 5; k++) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Player2 = function () {
	    ...
	    _createClass(Player2, [{
	        ...
	        key: "getColorWithOpacity",
	        value: function getColorWithOpacity(op) {
	        ...
	        value: function draw(ctx) {
	            ...
	            for (var k = 0; k < Math.floor(Math.random() * 3 + 1); k++) {
	                ...
	                ctx.lineTo(this.x + (Math.random() < 0.5 ? -this.width / 2 : this.width / 2) + Math.random() * this.mass / wildscale - this.mass / (wildscale * 2), this.y + (Math.random() < 0.5 ? -this.height / 2 : this.height / 2) + Math.random() * this.mass / wildscale - this.mass / (wildscale * 2));
	                ctx.stroke();
	                ctx.fill();
	            }
	            ctx.closePath();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Player1 = function () {
	    function Player1(x, y) {
	        ...
	        this.color = "rgba(200, 255, 200, 0.9)";

	        this.draw = this.draw.bind(this);
	        this.keyHandlerDown = this.keyHandlerDown.bind(this);
	        this.keyHandlerUp = this.keyHandlerUp.bind(this);
	        this.gravitateTo = this.gravitateTo.bind(this);
	    ...
	    _createClass(Player1, [{
	        ...
	        value: function draw(ctx) {
	            ...
	            ctx.strokeStyle = "rgba(255, 255, 255, 0.8)";
	            ctx.moveTo(this.x, this.y);
	            ctx.fillStyle = "rgba(40, 250, " + (50 + Math.floor(Math.random() * 200)) + ", 0.5)";
	            for (var k = 0; k < Math.floor(Math.random() * 3 + 1); k++) {
	            ...
	            */
	            ...
	            ctx.beginPath();
	            ctx.fillStyle = "rgba(20, 160, 60, 0.9)";
	            var lastX = this.x + this.width,
	                lastY = this.y;
	            ctx.moveTo(lastX, lastY);
	            for (var i = 0; i < this.numSides + 1; i++) {
...
/***/ function(module, exports) {
	...
	var Meteor = function () {
	    function Meteor(x, y, radius, mass) {
	    ...
	    _createClass(Meteor, [{
	        ...
	        value: function draw(ctx) {
	            ...
	            for (var k = 0; k < Math.floor(Math.random() * 3 + 1); k++) {
	                ctx.lineTo(this.x + (Math.random() < 0.5 ? -this.radius / 2 : this.radius / 2) + Math.random() * this.radius - this.radius / 2, this.y + (Math.random() < 0.5 ? -this.radius / 2 : this.radius / 2) + Math.random() * this.radius - this.radius / 2);
	                ctx.stroke();
	                ctx.fill();
	            }
	            ctx.closePath();
...
/***/ function(module, exports) {
	...
	var EndgameAnimation = function () {
	    function EndgameAnimation(x, y, size) {
	        _classCallCheck(this, EndgameAnimation);
	    ...
	    return EndgameAnimation;
	}();

	exports.default = EndgameAnimation;
...
/***/ function(module, exports) {
	...
	var Player2Endgame = function () {
	    function Player2Endgame(x, y, size) {
	        _classCallCheck(this, Player2Endgame);
	    ...
	    _createClass(Player2Endgame, [{
	        ...
	        value: function draw(ctx) {
	            ...
	            for (var k = 0; k < Math.floor(Math.random() * 3 + 1); k++) {
	                ...
	                ctx.lineTo(this.x + (Math.random() < 0.5 ? -this.width / 2 : this.width / 2) + Math.random() * this.size - this.size / 2, this.y + (Math.random() < 0.5 ? -this.height / 2 : this.height / 2) + Math.random() * this.size - this.size / 2);
	                ctx.stroke();
	                ctx.fill();
	            }
	            ctx.closePath();
	    ...
	    return Player2Endgame;
	}();

	exports.default = Player2Endgame;
...
/***/ function(module, exports) {
	...
	var Player1Endgame = function () {
	    function Player1Endgame(x, y, size) {
	        _classCallCheck(this, Player1Endgame);
	    ...
	    _createClass(Player1Endgame, [{
	        ...
	        value: function draw(ctx) {
	            ...
	            */
	            ...
	            ctx.beginPath();
	            ctx.fillStyle = "rgba(20, 160, 60, 0.1)";
	            var lastX = this.x + this.width,
	                lastY = this.y;
	            ctx.moveTo(lastX, lastY);
	            for (var i = 0; i < this.numSides + 1; i++) {
	    ...
	    return Player1Endgame;
	}();

	exports.default = Player1Endgame;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _particle = __webpack_require__(177);
	    ...
	    function Firework(x, y) {
	        ...
	        for (var i = 0; i < 10; i++) {
	            var vel = Math.random() * 5 + 1,
	                ...
	                p = new _particle2.default(this.x, this.y, vel, dir, 0.2);
